...
def conv3x3mtl_add(in_planes, out_planes, stride=1, groups=1, dilation=1):
    """3x3 convolution with padding"""
    return Conv2dMtl(in_planes, out_planes, kernel_size=3, stride=stride,
...
class BottleneckMtl(nn.Module):
    ...
    def __init__(
        ...
        self.conv2 = conv3x3mtl_add(width, width, stride, groups, dilation)
...
def resnetmtl101(pretrained=False, **kwargs):
