...
def compute_accuracy(the_args, intensity_gamma, b1_model, class_means, \
    ...
    if print_info:
        ...
        print("  Current accuracy (Mixed)      :\t\t{:.2f} %".format(mixed_acc))  
    return [cnn_acc, icarl_acc, mixed_acc], fast_fc
